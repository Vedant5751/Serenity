            ...
            <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
              <div class="w-full flex-col justify-center items-start gap-8 flex">
                <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                  <h2 class="text-gray-900 dark:text-gray-100 text-4xl font-bold font-manrope leading-normal lg:text-start text-center">
                    Welcome to Serenity: Your Mental Health Companion
                  </h2>
                  <p class="text-gray-500 dark:text-gray-400 text-base font-normal leading-relaxed lg:text-start text-center">
                ...
                <div class="w-full lg:justify-start justify-center items-center sm:gap-10 gap-5 inline-flex">
                  <div class="flex-col justify-start items-start inline-flex">
                    <h3 class="text-gray-900 dark:text-gray-100 text-4xl font-bold font-manrope leading-normal">
                      24/7
                    </h3>
                    <h6 class="text-gray-500 dark:text-gray-400 text-base font-normal leading-relaxed">
                      Accessible Support
                    </h6>
                  </div>
                  <div class="flex-col justify-start items-start inline-flex">
                    <h4 class="text-gray-900 dark:text-gray-100 text-4xl font-bold font-manrope leading-normal">
                      100+
                    </h4>
                    <h6 class="text-gray-500 dark:text-gray-400 text-base font-normal leading-relaxed">
                      Resources
